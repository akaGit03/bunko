<x-app-layout>
    ...
    <div class="text-gray-600 py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <h2 class="font-semibold text-2xl text-center pt-4 pb-8 md:text-4xl">編集</h2>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex justify-center py-10">
                    <form class="w-full max-w-md md:max-w-xl" action="{{ route('books.update', $book) }}" method="POST" onsubmit="return confirm('これで更新しますか？')">
                        @method('patch')
                        @include('books.form')
